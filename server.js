...
app.get('/', function(req, res) {
  ...
  res.send('<html><head><meta charset="UTF-8"></head><body style="font-family:Arial;text-align:center;padding:50px"><h1>Chat Server Running!</h1><p>Online: ' + count + '</p></body></html>');
});
